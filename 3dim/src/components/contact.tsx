...
const Contact: React.FC = () => {
  return (
    <section id="contact" className="section-padding bg-gradient-professional relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="text-center mb-16">
          ...
          >
            Contact <span className="text-primary-600 border-b-4 border-secondary-600 pb-2">Us</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Have questions or want to collaborate? We'd love to hear from you and
          ...
          {contactInfo.map((info, i) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="font-semibold text-neutral-900 mb-2 group-hover:text-primary-600 transition-all duration-300">{info.title}</h3>
                <p className="text-neutral-600 text-sm group-hover:text-neutral-700 transition-colors duration-300">{info.value}</p>
              </div>
            </motion.div>
          ))}
        </div>
