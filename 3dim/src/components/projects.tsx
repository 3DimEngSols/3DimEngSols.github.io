...
const projects: Project[] = [
  {
    ...
    description:
      "Our team developed an XML-based approach to predict the strength of glass powder concrete, contributing to sustainable civil engineering solutions.",
  ...
  },
  {
    ...
    description:
      "We introduced transparent AI models for predicting the strength of fly ash foam composites, pushing forward eco-friendly construction materials.",
  ...
  },
  {
    ...
    description:
      "Represented at The AI Summit in NYC, unveiling an AI-powered chatbot for automated Verilog circuit generation, revolutionizing FPGA & ASIC design.",
    icon: <Bot className="w-10 h-10 text-emerald-400" />,
  },
  {
    title: "Pipe-Bursting Simulation & Defect Detection",
    description:
      "Developed cutting-edge numerical models for brittle/ductile pipe bursting and AI-driven defect detection in turbine blades using signal processing.",
    icon: <Network className="w-10 h-10 text-emerald-400" />,
  },
  {
    title: "Deep Reinforcement Learning for Game Optimization",
    description:
      "Pioneered multi-agent DRL frameworks for multiplayer reach-avoid games, advancing strategy optimization and autonomous systems research.",
